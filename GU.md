...
For instance our development environment looks as follows (*May 2021*) <sup id="anchor_01"><a href="#footnote_01">[1]</a></sup>:

<pre style="font-size:80%;">
C:\opt\Git-2.31.1\               <i>(276 MB)</i>
C:\opt\graalvm-ce-java8-21.1.0\  <i>(360 MB)</i>
</pre>
...
Downloading: Component python-installable-svm-linux-amd64-21.1.0.jar
Install remote component python-installable-svm-linux-amd64-21.1.0.jar
...
Component ready to be installed in c:\opt\graalvm-ce-java8-21.1.0
Do you really want to add the component into directory c:\opt\graalvm-ce-java8-21.1.0 (y/*)? y
...
> 23.10.2019  09:43        65 156 656 python-installable-svm-linux-amd64-21.1.0.jar
> </pre>
...
&nbsp;
<b>&gt; curl -sL -o trufflesqueak-component.jar https://github.com/hpi-swa/trufflesqueak/releases/download/21.1.0/trufflesqueak-installable-java8-windows-amd64-21.1.0.jar</b>
&nbsp;
...
<pre style="font-size:80%;">
<b>&gt; <a href="bin/gu.bat">gu</a> install -u trufflesqueak-installable-java8-windows-amd64-21.1.0.jar</b>
Install remote component trufflesqueak-installable-java8-windows-amd64-21.1.0.jar
Do you really want to add the component into directory C:\opt\graalvm-ce-java8-21.1.0 (y/*)? y
Install GraalVM component into directory C:\opt\graalvm-ce-java8-21.1.0
</pre>
...
(current GraalVM version: "21.1.0")
</pre>
...
<a href="https://github.com/hpi-swa/trufflesqueak/releases/">trufflesqueak-installable-java8-windows-amd64-21.1.0.jar</a>  <i>(35 MB)</i>
<a href="https://github.com/oracle/graal/releases">graalvm-ce-windows-amd64-21.1.0.zip</a>             <i>(154 MB)</i>
...
<pre style="margin:0 0 1em 20px;font-size:80%;">
<b>&gt; where /r c:\opt\graalvm-ce-java8-21.1.0 js.cmd</b>
c:\opt\graalvm-ce-java8-21.1.0\bin\js.cmd
c:\opt\graalvm-ce-java8-21.1.0\jre\bin\js.cmd
&nbsp;
<b>&gt; js --version</b>
